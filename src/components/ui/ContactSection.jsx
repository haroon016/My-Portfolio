    ...
    <section id="contact" className="portfolio-section portfolio-section--contact">
      <div className="section-shell contact-panel" data-reveal>
        <div className="section-heading">
          ...
          <h2>Let’s build reliable delivery systems and better product operations.</h2>
        </div>

        <p className="contact-copy" data-reveal>
          If you are looking for someone who can connect product thinking, operational
          structure, QA discipline, and AI automation, I would love to connect.
        </p>
